                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={3} md={3} >
                                        <div className={classes.stats}>
                                            <Typography className={classes.typo} variant="body2">Drug Name</Typography>
                                            <br />
                                    ...
                                    <Grid item xs={12} sm={2} md={2} >
                                        <div className={classes.stats}>
                                            <Typography className={classes.typo} variant="body2">Strength(mg)</Typography>
                                            <br />
                                            <Typography className={classes.typoResult} variant="h6">
                                                500
                                        </Typography>
                                    ...
                                    <Grid item xs={12} sm={2} md={2} >
                                        <div className={classes.stats}>
                                            <Typography className={classes.typo} variant="body2">Drug Type</Typography>
                                            <br />
                                            <Typography className={classes.typoResult} variant="h6">
                                                Cap
                                        </Typography>
